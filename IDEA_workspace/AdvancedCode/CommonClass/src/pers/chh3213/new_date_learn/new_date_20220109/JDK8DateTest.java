package pers.chh3213.new_date_learn.new_date_20220109;
 ...
 * @Package : pers.chh3213.new_date_learn.new_date_20220109
 * @FileName : JDK8DateTest.java
 * @createTime : 2022/1/9 下午5:08
 * @Email :
 * @Description :
 */
public class JDK8DateTest {
    ...
    public void test2(){
        ...
        System.out.println(instant);    //2022-01-09T09:25:02.660388Z


        //添加时间的偏移量
        OffsetDateTime offsetDateTime = instant.atOffset(ZoneOffset.ofHours(8));//东八区
        System.out.println(offsetDateTime);   //2022-01-09T17:25:02.660388+08:00

        //toEpochMilli():获取自1970年1月1日0时0分0秒（UTC）开始的毫秒数  ---> Date类的getTime()
        long milli = instant.toEpochMilli();
        System.out.println(milli);  //1641720302660
